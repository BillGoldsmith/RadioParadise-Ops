import {Component, Inject, inject, Injectable, Injector, Input, OnChanges, SimpleChanges} from '@angular/core';
...
export class WidgetMusicBrainzListArtistComponent implements OnChanges{
    ...
    ngOnChanges(changes: SimpleChanges): void {
        ...
        setTimeout( () => {
            ...
            console.log('new breadnode', this.brainzExplorerBreadtrailNode);
        },1000) ;
